 ...
 */
public class Button_Simon_Information implements MediaPlayer.OnCompletionListener{
    ...
    public Button_Simon_Information(ImageButton _button, Context Application, int id, int active, int inactive){
        pressed = false;
        button = _button;
    ...
    public Button_Simon_Information(ImageButton _button, Context Application, int id, int active, int inactive,int id_go,ImageButton change_button){
        pressed = false;
        button = _button;
        sound = new Sound_Information(Application,id);
        sound.On_Completion(this);
